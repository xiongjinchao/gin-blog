...
INSERT INTO `article` (`id`, `title`, `cover`, `category_id`, `content`, `audit`, `hot`, `recommend`, `hit`, `favorite`, `comment`, `user_id`, `author`, `source`, `source_url`, `summary`, `keyword`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
INSERT INTO `book` (`id`, `name`, `tag`, `cover`, `catalogue`, `audit`, `hit`, `favorite`, `comment`, `summary`, `keyword`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Gin框架中文手册', 'gin web framework', 0, '```go\r\nfunction main(){\r\n	fmt.Println(\"Hello world!\")\r\n}\r\n```', 1, 0, 0, 0, '', '', '2019-08-07 23:43:36', '2019-09-30 17:42:10', NULL);
...
INSERT INTO `menu` (`id`, `name`, `tag`, `parent`, `level`, `audit`, `sort`, `summary`, `keyword`, `created_at`, `updated_at`, `deleted_at`) VALUES
